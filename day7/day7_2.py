...
root_size = max(x[1] for x in folder_sizes)

MAXIMUM_SIZE = 70000000
REQUIRED_SIZE = 30000000
SIZE_TO_DELETE = root_size - 40000000

free_size = root_size - REQUIRED_SIZE
available_options = [folder for folder in folder_sizes if folder[1] >= SIZE_TO_DELETE]
minimal_folder = min(x[1] for x in available_options)
print(minimal_folder)